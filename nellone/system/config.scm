...
(define-public nellone-system
  (operating-system
    ...
    (swap-devices
     (list (uuid "3fc8688e-9a4b-4713-a4d5-796d87c28fd5")))
    (file-systems
     (cons* (file-system
              (mount-point "/home")
              (device
               (uuid "5f6383fc-1e53-4baa-b2ef-75c2c22eff75"
                     'ext4))
              (type "ext4"))
            (file-system
              (mount-point "/")
              (device
               (uuid "3836b21b-9c07-42ba-a79f-cb320a24e096"
                     'ext4))
              (type "ext4"))
            (file-system
              (mount-point "/boot/efi")
              (device (uuid "D0F8-E8D1" 'fat32))
              (type "vfat"))
            %base-file-systems))))
